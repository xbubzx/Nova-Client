...
public class Configuration {
	...
	public static final String CLIENT_TITLE = "Nova-Prime";
	...
	public static final String CACHE_NAME = "NovaPrimeV3";

	public static boolean repackIndexOne = false, repackIndexTwo = false, repackIndexThree = false,
			repackIndexFour = false;
	
	
	public static final String CACHE_LINK = "https://www.novaprimers.com/cache/NovaPrimeV3.zip";

	public static final String MEDIA_ARCHIVES_LINK = "https://www.dropbox.com/s/r3vfpz2r6b79zar/media_archives.zip?dl=1"; 
																																																	
	
	public static final String SPRITE_CACHE_URL = "https://www.dropbox.com/s/bzgm2vs9pzj2o2y/sprites.zip?dl=1"; 
	
	public static final String VERSION_URL = ""; //not used
