...
public class FloorOverlayDefinition {
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		...
		int overlaysSize = stream.readUnsignedWord();
		System.out.println("Floor overlay: " + overlaysSize);
		if (overlays == null)
			overlays = new FloorOverlayDefinition[overlaysSize];
	...
	public static int hsl24to16(int i, int j, int k) {
		if (k > 179)
			j /= 2;
		if (k > 192)
			j /= 2;
