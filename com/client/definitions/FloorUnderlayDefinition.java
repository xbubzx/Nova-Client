...
public final class FloorUnderlayDefinition {
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		...
		int underlaysSize = stream.readUnsignedWord();
		System.out.println("Floor underlay: " + underlaysSize);
		if (underlays == null)
			underlays = new FloorUnderlayDefinition[underlaysSize];
		for (int j = 0; j < underlaysSize; j++) {
			if (underlays[j] == null) {
