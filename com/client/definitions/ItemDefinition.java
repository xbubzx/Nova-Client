	...
	private static void customItems(int itemId) {
		...
		case 2566: // Ring of duelling
			...
			case 21307:
				...
				break;
			case 11739:
				itemDef.name = "@yel@Cosmetic Box";
				break;
			case 3469:
				itemDef.name = "Super Crystal Key";
				itemDef.description = "Exchange this for better crystal key loot.";
				break;
			case 2996:
			...
			case 6802:
				...
				itemDef.description = "Read this scroll to be rewarded donator points.";
				break;
			case 6803:
			...
			case 6806:
				...
				break;
			case 6807:
				itemDef.name = "$200 Scroll";
				itemDef.description = "Read this scroll to be rewarded donator points.";
				break;
			case 13346:
				itemDef.name = "@whi@Ultra Mystery Box";
			...
			case 6828:
				...
				itemDef.description = "Starter box that contains goodies.";
				break;
			case 6855:
				itemDef.name = "@red@Referral Box";
				itemDef.inventoryOptions = new String[] { "Info", null, null, null, null, };
				itemDef.description = "Referal Box.";
				break;
			case 2883:
				...
				itemDef.anInt184 = 62750;
				itemDef.anInt196 = 62750;
			...
			case 22830:
				...
				itemDef.description = "Pvp armour that can be degraded once worn!";
			break;
			case 22831:
	...
	private void readValues(Stream stream) {
		while (true) {
			...
			if (opcode == 1)
				...
				opcode9 = stream.readUnsignedWord();
			else if (opcode == 10)
				opcode10 = stream.readUnsignedWord();
			} else if (opcode == 11)
				stackable = true;
			else if (opcode == 12)
				value = stream.readDWord();
			else if (opcode == 13)
				opcode13 = stream.readUnsignedWord();
			else if (opcode == 15)
				opcode15 = stream.readUnsignedWord();
			else if (opcode == 16)
				membersObject = true;
			else if (opcode == 21) 
				opcode21 = stream.readUnsignedWord();
			else if (opcode == 23) {
				...
				opcode29 = stream.readUnsignedWord();
			}
				...
				opcode42 = stream.readUnsignedWord();
			else if (opcode == 65)
				searchableItem = true;
			else if (opcode == 72)
				opcode72 = stream.readUnsignedWord();
			else if (opcode == 75)
				opcode75 = stream.readUnsignedWord();
			else if (opcode == 78)
				anInt185 = stream.readUnsignedWord();
			else if (opcode == 79)
				anInt162 = stream.readUnsignedWord();
			else if (opcode == 80)
				opcode80 = stream.readUnsignedWord();
			else if (opcode == 84)
				opcode84 = stream.readUnsignedWord();
			else if (opcode == 85)
				opcode85 = stream.readUnsignedWord();
			else if (opcode == 90)
				...
				opcode116 = stream.readUnsignedWord();
			else if (opcode == 137)
				opcode137 = stream.readUnsignedWord();
			else if (opcode == 139)
				...
				opcode151 = stream.readUnsignedWord();
			else if (opcode == 226)
				opcode226 = stream.readUnsignedWord();
			else if (opcode == 252)
				opcode252 = stream.readUnsignedWord();
			else if (opcode == 255)
				opcode255 = stream.readUnsignedWord();
			else {
