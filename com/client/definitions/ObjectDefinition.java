	...
	public static ObjectDefinition forID(int i) {
		...
		case 8207:
			...
			case 8720:
				...
				break;
			case 7431:
				objectDef.name = "Hiscores Lookup";
				break;
			case 24101:
		...
		case 9768:
			...
			objectDef.name = "@red@Donator Boss Zone";
			break;
		case 9772:
			objectDef.actions = new String[] { "Teleport", null, null, null, null };
			objectDef.name = "@blu@Super Donator Boss Zone";
			break;
		case 9770:
			objectDef.actions = new String[] { "Teleport", null, null, null, null };
			objectDef.name = "@gre@Extreme Donator Boss Zone";
			break;
	...
	public void readValues(Stream stream) {
		...
		//do {
			...
			if (type == 1) {
				...
				anInt738 = stream.readUnsignedWord();
			else if (type == 71)
				anInt745 = stream.readUnsignedWord();
			else if (type == 72)
				anInt783 = stream.readUnsignedWord();
			else if (type == 73)
				aBoolean736 = true;
			else if (type == 74)
				aBoolean766 = true;
			...
			childrenIDs[len + 1] = value;
				...
				System.out.println("invalid object opcode: " + type + " last " + lastSuccess);
				continue;
			}
			 lastSuccess = type;
