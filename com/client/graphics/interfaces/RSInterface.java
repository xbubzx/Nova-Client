...
public class RSInterface {
	...
	public static void questTab(TextDrawingArea[] tda) {
		...
		addText(10222, "@or1@Welcome to Nova-Prime", tda, 2, 16750899, true, true);
	...
	/*public static void questTab(TextDrawingArea[] tda) {
		RSInterface tab = addTabInterface(10220);
		addText(10221, "@or1@Control Panel", tda, 2, 16750899, false, true);
		addText(10222, "@or1@www.WisdomOsrs.com", tda, 2, 16750899, true, true);
		addSprite(10224, 0, "Interfaces/infoTab/SPRITE");
		addButton(10403, 2, "Interfaces/infoTab/TAB", "Refresh Tab");
		addButton(10404, 4, "Interfaces/infoTab/TAB", "View Diaries");
		addSprite(10223, 1, "Interfaces/infoTab/SPRITE");
		...
		infoList.newScroller = false;
		addText(10406, "@or1@Server information", tda, 2, 16750899, false, true);
		addHoverText(10407, "@cr10@@pur@Players online : @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10408, "@cr21@@pur@Wilderness count: @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10409, "@cr22@@pur@Raids count : @red@None", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10410, "@cr19@@pur@Current event: @red@None ", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10411, "@cr22@@pur@Deals Active: @red@None", "View Details", tda, 0, 1022259, false, true, 150);
		addText(10412, "@or1@Player information", tda, 2, 16750899, false, true);
		addHoverText(10225, "@cr20@@pur@Time Played = @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10226, "@cr1@@pur@Player Rank = @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10227, "@cr9@@pur@Amount donated = @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10228, "@cr17@@pur@Slayer Task : @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10229, "@cr17@@pur@Slayer Task Amount : @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10230, "@cr16@@pur@Pvm Points = : @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10231, "@cr22@@pur@Slayer Points = : @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10232, "@cr22@@pur@Vote Points = : @gre@", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10233, "@cr22@@pur@Daily task = : @gre@", "View Details", tda, 0, 1022259, false, true, 150);
   ...
   /* public static void questTab(TextDrawingArea[] tda) {
	    RSInterface tab = addTabInterface(10220);
	    addText(10221, "@cr17@ Info", tda, 2, 16750899, false, true);
	    addText(10222, "Players Online: @gre@0", tda, 2, 16750899, true, true);
	    addSprite(10224, 0, "Interfaces/infoTab/SPRITE");
	    addButton(10401, 0, "Interfaces/infoTab/TAB", "View Main Information");
	    addButton(10402, 1, "Interfaces/infoTab/TAB", "View Achievements");
	    addButton(10403, 2, "Interfaces/infoTab/TAB", "View Drop Tables");
	    addButton(10404, 3, "Interfaces/infoTab/TAB", "View Settings");
	    addButton(10405, 4, "Interfaces/infoTab/TAB", "View Donator Tab");
	    addSprite(10223, 1, "Interfaces/infoTab/SPRITE");
	    
	    tab.totalChildren(11);
	    tab.child(0, 10221, 10, 10);
	    tab.child(1, 10222, 95, 240);
	    tab.child(2, 10224, 0, 35);
	    tab.child(3, 10223, 0, 230);
	    tab.child(4, 10401, 95, 15);
	    tab.child(5, 10402, 114, 15);
	    tab.child(6, 10403, 133, 15);
	    tab.child(7, 10404, 152, 15);
	    tab.child(8, 10405, 171, 15);
	    tab.child(9, 10223, 0, 32);
	    tab.child(10, 10280, 2, 34);
	    
	    RSInterface infoList = addTabInterface(10280);
	    infoList.height = 196;
	    infoList.width = 172;
	    infoList.scrollMax = 850;
	    infoList.newScroller = false;
	    
	    addText(10406, "@cr2@ Server Information", tda, 2, 16750899, false, true);
	    ...
	    addText(10412, "@cr1@ Account Information", tda, 2, 16750899, false, true);
	    
	    infoList.totalChildren(58);
	    infoList.child(0, 10406, 4, 4);
	    infoList.child(1, 10407, 8, 22);
	    infoList.child(2, 10408, 8, 35);
	    infoList.child(3, 10409, 8, 48);
	    infoList.child(4, 10410, 8, 61);
	    infoList.child(5, 10411, 8, 74);
	    infoList.child(6, 10412, 4, 90);
	    ...
	    for (int iD = 10225; iD <= 10275; iD++) {
	      addHoverText(iD, "", "View", tda, 
	        0, 16711680, false, true, 150);
	      infoList.child(frameID, iD, 8, Ypos);
	      frameID++;
	      Ypos += 13;
	      Ypos++;
	    }
	    ...
	    try
	    {
	      addText(29466, "@cr17@ Diaries", tda, 2, 16750899, false, true);
	      addSprite(29467, 0, "Interfaces/infoTab/SPRITE");
	      addButton(29468, 0, "Interfaces/infoTab/TAB", "View Main Information");
	      addButton(29469, 1, "Interfaces/infoTab/TAB", "View Achievements");
	      addButton(29470, 2, "Interfaces/infoTab/TAB", "View Drop Tables");
	      addButton(29471, 3, "Interfaces/infoTab/TAB", "View Settings");
	      addButton(29472, 4, "Interfaces/infoTab/TAB", "View Donator Tab");
	      addSprite(29473, 1, "Interfaces/infoTab/SPRITE");
	      addText(29474, "Diaries Completed: @gre@0", tda, 2, 16750899, true, true);
	      ...
	      aDiary.child(4, 29469, 114, 15);
	      aDiary.child(5, 29470, 133, 15);
	      aDiary.child(6, 29471, 152, 15);
	      aDiary.child(7, 29472, 171, 15);
	      aDiary.child(8, 29473, 0, 32);
	      aDiary.child(9, 29474, 95, 240);
	      aDiary.child(10, 29475, 2, 34);
	    ...
	    RSInterface settings = addTabInterface(30465);
	    try
	    {
	      addText(30466, "@cr1@ Settings", tda, 2, 16750899, false, true);
	      addSprite(30467, 0, "Interfaces/infoTab/SPRITE");
	      addButton(30468, 0, "Interfaces/infoTab/TAB", "View Information");
	      addButton(30469, 1, "Interfaces/infoTab/TAB", "View Achievements");
	      addButton(30470, 2, "Interfaces/infoTab/TAB", "View Drop Tables");
	      addButton(30471, 3, "Interfaces/infoTab/TAB", "View Settings");
	      addButton(30472, 4, "Interfaces/infoTab/TAB", "View Donator Tab");
	      addSprite(30473, 1, "Interfaces/infoTab/SPRITE");
	      
	      RSInterface settingList = addTabInterface(30475);
	      settingList.height = 196;
	      settingList.width = 172;
	      settingList.scrollMax = 400;
	      settingList.newScroller = false;
	      
	      settings.totalChildren(10);
	      settings.child(0, 30466, 10, 10);
	      settings.child(1, 30467, 0, 35);
	      settings.child(2, 30473, 0, 230);
	      settings.child(3, 30468, 95, 15);
	      settings.child(4, 30469, 114, 15);
	      settings.child(5, 30470, 133, 15);
	      settings.child(6, 30471, 152, 15);
	      settings.child(7, 30472, 171, 15);
	      settings.child(8, 30473, 0, 32);
	      settings.child(9, 30475, 2, 34);
	      
	      settingList.totalChildren(31);
	      int Ypos3 = 8;
	      int frameID3 = 0;
	      for (int iD3 = 30480; iD3 <= 30510; iD3++) {
	        addHoverText(iD3, "", "View", tda, 
	          0, 16711680, false, true, 150);
	        settingList.child(frameID3, iD3, 8, Ypos3);
	        frameID3++;
	        Ypos3 += 13;
	        Ypos3++;
	      }
	    ...
	    RSInterface donorTab = addTabInterface(31465);
	    try
	    {
	      addText(31466, "@cr8@ Donator", tda, 2, 16750899, false, true);
	      addSprite(31467, 0, "Interfaces/infoTab/SPRITE");
	      addButton(31468, 0, "Interfaces/infoTab/TAB", "View Main Information");
	      addButton(31469, 1, "Interfaces/infoTab/TAB", "View Achievements");
	      addButton(31470, 2, "Interfaces/infoTab/TAB", "View Drop Tables");
	      addButton(31471, 3, "Interfaces/infoTab/TAB", "View Settings");
	      addButton(31472, 4, "Interfaces/infoTab/TAB", "View Donator Tab");
	      addSprite(31473, 1, "Interfaces/infoTab/SPRITE");
	      
	      RSInterface donorList = addTabInterface(31475);
	      donorList.height = 196;
	      donorList.width = 172;
	      donorList.scrollMax = 400;
	      donorList.newScroller = false;
	      
	      donorTab.totalChildren(10);
	      donorTab.child(0, 31466, 10, 10);
	      donorTab.child(1, 31467, 0, 35);
	      donorTab.child(2, 31473, 0, 230);
	      donorTab.child(3, 31468, 95, 15);
	      donorTab.child(4, 31469, 114, 15);
	      donorTab.child(5, 31470, 133, 15);
	      donorTab.child(6, 31471, 152, 15);
	      donorTab.child(7, 31472, 171, 15);
	      donorTab.child(8, 31473, 0, 32);
	      donorTab.child(9, 31475, 2, 34);
	      
	      donorList.totalChildren(31);
	      int Ypos3 = 8;
	      int frameID3 = 0;
	      for (int iD3 = 31480; iD3 <= 31510; iD3++) {
	        addHoverText(iD3, "", "View", tda, 
	          0, 16711680, false, true, 150);
	        donorList.child(frameID3, iD3, 8, Ypos3);
	        frameID3++;
	        Ypos3 += 13;
	        Ypos3++;
	      }
	...
	public static void wellOfGoodWill(TextDrawingArea[] tda) {
		...
		addText(38012, "10M/50M", tda, 0, 0xFF981F, true, true);
		addText(38013, "10M/50M", tda, 0, 0xFF981F, true, true);
		addText(38014, "10M/500M", tda, 0, 0xFF981F, true, true);
		setChildren(16, wogw);
		...
		addText(38033, "Bubz donated 10.000.000 towards x2 experience", tda, 0, 0xFF981F, false, true);
		addText(38034, "Bubz donated 10.000.000 towards +5 PC Points", tda, 0, 0xFF981F, false, true);
		addText(38035, "Bubz donated 10.000.000 towards Double drops", tda, 0, 0xFF981F, false, true);
		addText(38036, "Bubz donated 10.000.000 towards Double drops", tda, 0, 0xFF981F, false, true);
		addText(38037, "Bubz donated 10.000.000 towards Double drops", tda, 0, 0xFF981F, false, true);
		setChildren(7, last);
